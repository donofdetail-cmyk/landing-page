            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-16">
                <div className="relative pl-4 sm:pl-8">
                  <div className="absolute top-0 left-0 -translate-y-10 sm:-translate-x-4 text-[120px] font-serif font-bold text-don-gold/15 leading-none tracking-tighter select-none pointer-events-none z-0">
                    01.
                  </div>
