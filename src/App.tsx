...
import { Shield, Star, CheckCircle, Phone, ChevronDown, Award, Instagram, ClipboardList, CalendarCheck, Sparkles } from 'lucide-react';
          ...
          <div className="mb-24 max-w-3xl mx-auto">
            <div className="flex flex-col items-center gap-2 mb-10">
              <div className="flex justify-center gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star key={star} className="w-6 h-6 text-don-gold fill-don-gold" />
                ))}
              </div>
              <span className="text-don-cream/50 text-xs uppercase tracking-widest">5.0 · 70+ Google Reviews</span>
            </div>
