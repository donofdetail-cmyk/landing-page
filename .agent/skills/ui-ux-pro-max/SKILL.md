...
**User request:** "Build a premium auto detailing landing page"

### Step 1: Analyze Requirements
- Product type: Auto detailing service
- Style keywords: premium, dark, luxury, sleek
- Industry: Automotive services
- Stack: react (Vite project)

### Step 2: Generate Design System (REQUIRED)

```bash
python3 .agent/skills/ui-ux-pro-max/scripts/search.py "auto detailing luxury premium service dark" --design-system -p "Don of Detail"
```
...
```bash
python3 .agent/skills/ui-ux-pro-max/scripts/search.py "layout responsive form" --stack react
```
